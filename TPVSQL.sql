CREATE DATABASE  IF NOT EXISTS `tpv` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tpv`;
...
CREATE TABLE `productos` (
  ...
  `id_categoria` varchar(25) NOT NULL,
  `url_codigobarras` varchar(50) NOT NULL,
  `iva` int NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `sesion_abierta` tinyint NOT NULL,
...
INSERT INTO `usuarios` VALUES ('AY045522','maicol','1993',0,'2024-05-05','imguser/gato.jpg','Admin'),('AY045523','Nala','1992',0,'2024-05-05','imguser/sonic.png','Usuario'),('AY045529','root','2003',0,'2024-05-04','imguser/tux.jpg','Superoot');
...
-- Dump completed on 2024-05-05  0:20:15
